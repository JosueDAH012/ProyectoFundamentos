 ...
 * @author Usuario
 */
public class PagarFr extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagarFr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
