 ...
 * @author asus
 */
public class MiHorarioPr extends javax.swing.JFrame {
 DefaultTableModel model3 = new DefaultTableModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MiHorarioPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MiHorarioPr().setVisible(true);
            }
        });
    }
