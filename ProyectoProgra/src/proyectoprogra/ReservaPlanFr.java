 ...
 * @author Usuario
 */
public class ReservaPlanFr extends javax.swing.JFrame {

    DefaultTableModel model = new DefaultTableModel();
    
    
    
    public ReservaPlanFr() {
        initComponents();
    ...
    ConfirmeHorarioFr x= new ConfirmeHorarioFr();
...
JCBhoracurso.setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservaPlanFr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservaPlanFr().setVisible(true);
            }
        });
    }
