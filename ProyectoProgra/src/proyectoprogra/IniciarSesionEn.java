 ...
 * @author Usuario
 */
public class IniciarSesionEn extends javax.swing.JFrame {

    /**
     * Creates new form IniciarSesion
     */
    public IniciarSesionEn() {
        initComponents();
    }
    ...
    private void JbtIniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JbtIniciarSesionMouseClicked
        System.out.println("It was saved correctly");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IniciarSesionEn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IniciarSesionEn().setVisible(true);
            }
        });
    }
