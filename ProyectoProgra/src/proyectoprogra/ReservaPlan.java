 ...
 * @author Usuario
 */
public class ReservaPlan extends javax.swing.JFrame {
    ...
    ConfirmeHorario x = new ConfirmeHorario();
    public static String dia, sus, hora;
    int tipo = 1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservaPlan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservaPlan().setVisible(true);
            }
        });
    }
