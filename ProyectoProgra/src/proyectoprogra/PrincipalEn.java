 ...
 * @author Usuario
 */
public class PrincipalEn extends javax.swing.JFrame {
    ...
    private void jBtIniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtIniciarSesionMouseClicked
        IniciarSesionEn d = new IniciarSesionEn();
        d.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalEn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalEn().setVisible(true);
            }
        });
    }
