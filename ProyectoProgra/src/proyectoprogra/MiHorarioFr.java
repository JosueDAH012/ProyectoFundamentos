 ...
 * @author asus
 */
public class MiHorarioFr extends javax.swing.JFrame {
 DefaultTableModel model3 = new DefaultTableModel();
    ...
    public MiHorarioFr() {
        initComponents();
        model3.addColumn("Jour");
        model3.addColumn("Abonnement");
        model3.addColumn("Cours");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MiHorarioFr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MiHorarioFr().setVisible(true);
            }
        });
    }
