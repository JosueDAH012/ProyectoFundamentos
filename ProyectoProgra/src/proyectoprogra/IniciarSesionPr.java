 ...
 * @author Usuario
 */
public class IniciarSesionPr extends javax.swing.JFrame {

    /**
     * Creates new form IniciarSesion
     */
    public IniciarSesionPr() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IniciarSesionPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IniciarSesionPr().setVisible(true);
            }
        });
    }
