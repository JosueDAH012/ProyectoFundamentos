 ...
 * @author asus
 */
public class MiHorarioEn extends javax.swing.JFrame {
 DefaultTableModel model3 = new DefaultTableModel();
    ...
    public MiHorarioEn() {
        initComponents();
        model3.addColumn("Day");
        model3.addColumn("Subscription");
        model3.addColumn("Course");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MiHorarioEn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MiHorarioEn().setVisible(true);
            }
        });
    }
