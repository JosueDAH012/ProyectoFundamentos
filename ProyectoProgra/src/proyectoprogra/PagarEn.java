 ...
 * @author Usuario
 */
public class PagarEn extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagarEn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
