 ...
 * @author Usuario
 */
public class ReservaPlanPr extends javax.swing.JFrame {

    DefaultTableModel model = new DefaultTableModel();
    
    
    
    public ReservaPlanPr() {
        initComponents();
        model.addColumn("Digite#");
        model.addColumn("Dia");
        model.addColumn("Assinatura");
    ...
    ConfirmeHorarioPr x= new ConfirmeHorarioPr();
...
JCBhoracurso.setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservaPlanPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservaPlanPr().setVisible(true);
            }
        });
    }
