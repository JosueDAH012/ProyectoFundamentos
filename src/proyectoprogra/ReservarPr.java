 ...
 * @author frano
 */
public class ReservarPr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Intruccion2.setText("Insira suas informações de reserva");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservarPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservarPr().setVisible(true);
            }
        });
    }
