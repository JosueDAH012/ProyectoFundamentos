 ...
 * @author frano
 */
public class ReservarAl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Intruccion2.setText("Ich habe die daten ihrer reservierung eingegeben");

        JLBdia.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        JLBdia.setForeground(new java.awt.Color(255, 153, 0));
        JLBdia.setText("Tag");

        JCBdia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Auswählen:", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag", "Sonntag" }));

        JLBdia1.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        JLBdia1.setForeground(new java.awt.Color(255, 153, 0));
        JLBdia1.setText("Zeitplan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservarAl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservarAl().setVisible(true);
            }
        });
    }
