 ...
 * @author Usuario
 */
public class RegistroEn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Intruccion.setText(" Fill the following spaces");
        ...
        JLBcontrasena.setText("Password");
        ...
        JLBcnfcontrasena.setText("Cnf Password");
        ...
        JLBapellidos.setText("Last Name");
        ...
        JCBXsexo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select:", "Man", "Female", "Other" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroEn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroEn().setVisible(true);
            }
        });
    }
