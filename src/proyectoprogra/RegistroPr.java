 ...
 * @author Usuario
 */
public class RegistroPr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Intruccion.setText("Preencha os seguintes espaços");
        ...
        JLBcontrasena.setText("Contrsaseña");
        ...
        JCBXsexo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione:", "Macho", "Feminino", "Outro" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroPr().setVisible(true);
            }
        });
    }
