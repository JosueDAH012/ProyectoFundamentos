...
public class PrincipalFr extends javax.swing.JFrame {
    ...
    private void jBtIniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtIniciarSesionMouseClicked
        IniciarSesionFr d = new IniciarSesionFr();
        d.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalFr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalFr().setVisible(true);
            }
        });
    }
