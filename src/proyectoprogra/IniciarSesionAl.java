 ...
 * @author Usuario
 */
public class IniciarSesionAl extends javax.swing.JFrame {

    /**
     * Creates new form IniciarSesion
     */
    public IniciarSesionAl() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IniciarSesionAl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IniciarSesionAl().setVisible(true);
            }
        });
    }
