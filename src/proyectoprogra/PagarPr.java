 ...
 * @author Usuario
 */
public class PagarPr extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagarPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
