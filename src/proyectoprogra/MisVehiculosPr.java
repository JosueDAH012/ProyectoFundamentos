 ...
 * @author Usuario
 */
public class MisVehiculosPr extends javax.swing.JFrame {
     DefaultTableModel misvehiculos = new DefaultTableModel();
   
    public MisVehiculosPr() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MisVehiculosPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MisVehiculosPr().setVisible(true);
            }
        });
